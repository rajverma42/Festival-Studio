...
const hi = {
  ...
  festival: {
    ...
    desc: 'मुफ़्त {name} ({en}) पोस्ट, पोस्टर और ग्रीटिंग ऑनलाइन बनाएँ। हिन्दी और अंग्रेज़ी टेम्पलेट — अपने नाम, फ़ोटो, बिज़नेस लोगो और ऑफ़र के साथ। न साइनअप, न वॉटरमार्क।',
    h1: '{name} पोस्ट मेकर',
    intro: '{desc} अपना नाम, फ़ोटो, बिज़नेस जानकारी और लोगो जोड़कर हिन्दी, अंग्रेज़ी या हिंग्लिश में मुफ़्त {name} ({en}) पोस्ट, पोस्टर या व्हाट्सऐप स्टेटस बनाइए।',
